...
class Train:
    ...
    def __init__(self, root): 
        ...
        img_top=Image.open(r"Facial_Recognition_App\images_face_recog\facialrecognition.jpg")
        ...
        img_bottom=Image.open(r"Facial_Recognition_App\images_face_recog\opencv_face_reco_more_dat.jpg") 
